...
package me.gserv.archival.m3.data

import me.gserv.archival.m3.config.AppSettings
import me.gserv.archival.m3.data.entities.Binder
import java.io.File
...
object Filesystem {
	...
	val bindersFolder
		get() =
			AppSettings.dataFolder?.let { Path(it, "binders").absolute() }

	val inputFolder
		get() =
			AppSettings.dataFolder?.let { Path(it, "import").absolute() }
